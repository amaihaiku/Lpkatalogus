...
#include "Input/AnalogJoystick.h"
#endif
...
#ifdef USE_ANALOG_JOYSTICK
  AnalogJoystick *analogJoystick = new AnalogJoystick([&](SpecKeys key, bool down)
                                                { navigationStack->updateKey(key, down); },
                                                [&](SpecKeys key)
                                                { navigationStack->pressKey(key); },
                                                JOY_X_PIN, JOY_Y_PIN, JOY_BTN_A_PIN, JOY_BTN_B_PIN, JOY_BTN_MENU_PIN);
  analogJoystick->start();
#endif
